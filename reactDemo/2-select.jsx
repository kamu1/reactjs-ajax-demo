...
var MainBox=React.createClass({
	getInitialState:function(){
		return {
			data:[
			{"id":1,"name":"前端开发1班","num":35,"teacher":"李老师","time":"2016-02-11"},
			{"id":2,"name":"JAVA开发3班","num":52,"teacher":"金老师","time":"2016-03-20"},
			{"id":3,"name":"JAVA开发5班","num":35,"teacher":"马老师","time":"2016-06-10"}
			]
		}
	},
	//选择行
